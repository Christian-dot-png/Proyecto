            ...
            <ion-accordion v-for="(menu, index) in userStore.menu" :key="index">
              ...
              <div class="ion-padding" slot="content">
                <ion-menu-toggle :auto-hide="true" v-for="(p, i) in menu.sub" :key="i">
                  <ion-item 
                    @click="selectedIndex = Number(i)" 
                    router-direction="root" 
                    :router-link="'/'+p.url" 
                    lines="none" 
                    :detail="false" 
                    class="hydrated" 
                    :class="{ selected: selectedIndex === Number(i) }"
                  >
...
import { ref } from 'vue';
import { IonButtons, IonContent, IonHeader, IonMenu, IonMenuButton, IonPage, IonTitle, IonToolbar, IonAvatar, IonButton, IonAccordionGroup, IonAccordion, IonItem, IonLabel, IonList, IonMenuToggle } from '@ionic/vue';
import {
  archiveOutline,
  archiveSharp,
  bookmarkOutline,
